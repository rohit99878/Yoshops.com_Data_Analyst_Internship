...
for i in range(1,10):
    url = "https://www.flipkart.com/search?q=socks+hrx&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off&page="+str(i)
...
df.to_csv("C:/Users/Rohit/Desktop/Yoshop_Internship/Tasks/Task-6/socks.csv")
